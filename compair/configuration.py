...
env_overridables = [
    ...
    'USER_LOOKUP_LDAP_URL', 'USER_LOOKUP_LDAP_PROXY_AGENT',
    'USER_LOOKUP_LDAP_PROXY_PASSWORD', 'USER_LOOKUP_LDAP_BASE_DN',
    'USER_LOOKUP_LDAP_SEARCH_USERNAME_ATTRS', 'USER_LOOKUP_LDAP_SEARCH_STUDENT_NUM_ATTRS',
    'USER_LOOKUP_LDAP_SEARCH_UNIQUE_IDENTIFIER_ATTRS',
...
env_bool_overridables = [
    ...
    'ENFORCE_SSL', 'IMPERSONATION_ENABLED', 'USER_LOOKUP_LDAP_ENABLED'
]

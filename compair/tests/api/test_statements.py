...
from compair.api import register_statement_api_blueprints
from compair.models import XAPILog

class StatementAPITests(ComPAIRAPITestCase):
    def setUp(self):
        super(StatementAPITests, self).setUp()
    ...
    def test_create_statement(self):
        ...
        self.app = register_statement_api_blueprints(self.app)

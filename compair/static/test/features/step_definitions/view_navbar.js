...
var viewNavbarStepDefinitionsWrapper = function () {
    ...
    this.Then("I should see the admin navigation items", function () {
        return expect(element.all(by.css("#logged-in-nav-options li a")).getText()).to.eventually.eql(["Download Reports", "Add Course", "Manage Users", "Create Account", "Manage LTI"]);
    });

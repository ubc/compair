            ...
            it('should generate a valid statement', function() {
                var expectedStatement = {
                    ...
                    "result":{
                        ...
                        "extensions":{
                            "http://xapi.ubc.ca/extension/character-count":16,
                            "http://xapi.ubc.ca/extension/word-count":4
                        }
                    },
                    "context":{
        ...
        describe('filtered_page:', function() {
            it('should generate a valid statement', function() {
                var expectedStatement = {
                    ...
                    "context":{
                        "extensions": {
                            "http://xapi.ubc.ca/extension/filters": mockFilters
                        },
                        "contextActivities":{
                            "other":[{
                                "id": mockLocationAbsUrl,
        ...
        describe('sorted_page:', function() {
            it('should generate a valid statement', function() {
                var expectedStatement = {
                    ...
                    "context":{
                        "extensions": {
                            "http://xapi.ubc.ca/extension/sort-order": mockSortOrder
                        },
                        "contextActivities":{
                            "other":[{
                                "id": mockLocationAbsUrl,
            ...
            it('should generate a valid statement', function() {
                var expectedStatement = {
                    ...
                    "object":{
                        ...
                        "objectType":"Activity",
                        "definition":{
                            "type":"http://xapi.ubc.ca/activitytype/modal",
                ...
                var expectedStatement = {
                    ...
                    "object":{
                        ...
                        "definition":{
                            ...
                            "extensions": {
                                "http://xapi.ubc.ca/extension/comparison": comparisonNumber,
                                "http://xapi.ubc.ca/extension/score-algorithm": "random"
                            }
                        },
                    }
                };
            ...
            it('should generate a valid statement', function() {
                var expectedStatement = {
                    ...
                    "result": {
                        ...
                        "extensions": {
                            "http://xapi.ubc.ca/extension/character-count": 22,
                            "http://xapi.ubc.ca/extension/word-count": 1
                        }
                    },
                    "object":{

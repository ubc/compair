 ...
 *
 * Vendored from https://github.com/egesu/ng-breadcrumbs (Bower alias
 * "es-breadcrumbs") because it was never published to npm and its
 * repo has no package.json, so it can't be installed as a normal
 * npm/git dependency.
 */
(function(angular) {
  'use strict';

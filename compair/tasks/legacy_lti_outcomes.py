...
from compair.models import LegacyLTIConsumer, LegacyLTIOutcome, CourseGrade, AssignmentGrade
...
def update_lti_course_grades(self, lti_consumer_id, sourcedid_and_grades):
    lti_consumer = LegacyLTIConsumer.query.get(lti_consumer_id)
    if lti_consumer:
        ...
        for (lis_result_sourcedid, course_grade_id) in sourcedid_and_grades:
            if course_grade_id:
                ...
                LegacyLTIOutcome.post_replace_result(lti_consumer, lis_result_sourcedid, grade)

...
var editUserStepDefinitionsWrapper = function () {
    this.Then("I should see the full Account Details and Account Login sections of the Edit User form for students", function() {
        // Account Login
    ...
    this.Then("I should see the full Account Details and Account Login sections of the Edit User form for non-students", function() {
        // Account Login
        expect(element(by.model('user.username')).isPresent()).to.eventually.equal(true);
    ...
    this.Then("I should see the incomplete Account Details section of the Edit User form for students", function() {
        // Account Login
        expect(element(by.model('user.username')).isPresent()).to.eventually.equal(true);
    ...
    this.Then("I should see the incomplete Account Details section of the Edit User form for non-students", function() {
        // Account Login
        expect(element(by.model('user.username')).isPresent()).to.eventually.equal(true);

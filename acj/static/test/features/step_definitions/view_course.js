...
var viewCourseStepDefinitionsWrapper = function () {
	...
	this.Then(/^I should see my assignments with names:$/, function (data, done) {
	...
	this.When(/^I filter course page assignments by "([^"]*)"$/, function (filter, done) {
	...
	this.Then(/^I should see "([^"]*)" assignments$/, function (numberString, done) {

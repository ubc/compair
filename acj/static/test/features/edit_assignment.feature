Feature: Edit Assignment
  ...
  Scenario: Editing a assignment's criteria as instructor before comparisons
    Given I'm an Instructor with assignments
    And I'm on "edit assignment" page for assignment with id "3" and course id "1"
    ...
    And I fill in the criteria description with "Choose the one you like best."
  ...
  Scenario: Cannot Edit a assignment's criteria as instructor after its been compared
    Given I'm an Instructor with assignments

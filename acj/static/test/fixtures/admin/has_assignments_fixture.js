...
var criteria2 = criteriaFactory.generateCriteria(2, admin.id, {
...
var criteria3 = criteriaFactory.generateCriteria(3, admin.id, {
...
var assignment_finished = assignmentFactory.generateAssignment(1, admin, [defaultCriteria, criteria3], {
...
var assignment_being_compared = assignmentFactory.generateAssignment(2, admin, [defaultCriteria, criteria3], {
...
var assignment_being_answered = assignmentFactory.generateAssignment(3, admin, [defaultCriteria, criteria3], {
...
var assignment_upcoming = assignmentFactory.generateAssignment(4, admin, [defaultCriteria, criteria3], {

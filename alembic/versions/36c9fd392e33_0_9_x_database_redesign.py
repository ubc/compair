...
def upgrade():
    ...
    new_assignment_table = op.create_table(
        ...
        sa.Column('students_can_reply', sa.Boolean(name='students_can_reply'), nullable=False),
        sa.Column('enable_self_evaluation', sa.Boolean(name='enable_self_evaluation'), nullable=False),
        sa.Column('active', sa.Boolean(name='active'), nullable=False),
        sa.Column('modified_user_id', sa.Integer(), nullable=True),
        sa.Column('modified', sa.DateTime(), nullable=False),
        sa.Column('created_user_id', sa.Integer(), nullable=True),
    ...
    new_answer_table = op.create_table(
        ...
        sa.Column('flagged', sa.Boolean(name='flagged'), nullable=False),
    ...
    new_answer_comment_table = op.create_table(
        ...
        sa.Column('user_id', sa.Integer(), nullable=False),
        sa.Column('content', sa.Text(), nullable=True),
        sa.Column('comment_type', EnumType(AnswerCommentType, name="comment_type"), nullable=False),
        sa.Column('active', sa.Boolean(name='active'), nullable=False),
        sa.Column('modified_user_id', sa.Integer(), nullable=True),
        sa.Column('modified', sa.DateTime(), nullable=False),
        sa.Column('created_user_id', sa.Integer(), nullable=True),
...
def downgrade():
    ...
    old_course_table = op.create_table(
        ...
        sa.Column('name', sa.String(length=255), nullable=False),
        sa.Column('description', sa.Text(), nullable=True),
        sa.Column('available', sa.Boolean(name='available'), nullable=False),
        sa.Column('enable_student_create_questions', sa.Boolean(name='enable_student_create_questions'), nullable=False),
        sa.Column('enable_student_create_tags', sa.Boolean(name='enable_student_create_tags'), nullable=False),
        sa.Column('modified', sa.DateTime(), nullable=False),
        sa.Column('created', sa.DateTime(), nullable=False),
        sa.PrimaryKeyConstraint('id'),
        mysql_collate='utf8_unicode_ci',
    ...
    old_assignment_table = op.create_table(
        ...
        sa.Column('can_reply', sa.Boolean(name='can_reply'), nullable=False),
        sa.Column('modified', sa.DateTime(), nullable=False),
    ...
    old_comparisons_comment_table =  op.create_table(
        ...
        sa.Column('selfeval', sa.Boolean(name='selfeval'), nullable=False),
    ...
    old_answer_comment_table = op.create_table(
        ...
        sa.Column('comments_id', sa.Integer(), nullable=True),
        sa.Column('evaluation', sa.Boolean(name='evaluation'), nullable=False),
        sa.Column('selfeval', sa.Boolean(name='selfeval'), nullable=False),

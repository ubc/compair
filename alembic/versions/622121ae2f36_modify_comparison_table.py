...
def upgrade():
    ...
    comparison_table = op.create_table('comparison',
        ...
        sa.Column('winner', EnumType(WinningAnswer, name='winner'), nullable=True),
        ...
        sa.Column('pairing_algorithm', EnumType(PairingAlgorithm, name='pairing_algorithm'), nullable=True),
